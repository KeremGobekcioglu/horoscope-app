...
enum class ZodiacSign(
    ...
    ARIES("aries", "aries", "koc", Res.string.sign_name_aries, Res.string.sign_dates_aries, Res.drawable.aries_constellation_icon, startDay = 21, startMonth = 3),
    TAURUS("taurus", "taurus", "boga", Res.string.sign_name_taurus, Res.string.sign_dates_taurus, Res.drawable.taurus_constellation_icon, startDay = 20, startMonth = 4),
    GEMINI("gemini", "gemini", "ikizler", Res.string.sign_name_gemini, Res.string.sign_dates_gemini, Res.drawable.gemini_constellation_icon, startDay = 21, startMonth = 5),
    CANCER("cancer", "cancer", "yengec", Res.string.sign_name_cancer, Res.string.sign_dates_cancer, Res.drawable.cancer_constellation_icon, startDay = 21, startMonth = 6),
    LEO("leo", "leo", "aslan", Res.string.sign_name_leo, Res.string.sign_dates_leo, Res.drawable.leo_constellation_icon, startDay = 23, startMonth = 7),
    VIRGO("virgo", "virgo", "basak", Res.string.sign_name_virgo, Res.string.sign_dates_virgo, Res.drawable.virgo_constellation_icon, startDay = 23, startMonth = 8),
    LIBRA("libra", "libra", "terazi", Res.string.sign_name_libra, Res.string.sign_dates_libra, Res.drawable.libra_constellation_icon, startDay = 23, startMonth = 9),
    SCORPIO("scorpio", "scorpio", "akrep", Res.string.sign_name_scorpio, Res.string.sign_dates_scorpio, Res.drawable.scorpio_constellation_icon, startDay = 23, startMonth = 10),
    SAGITTARIUS("sagittarius", "sagittarius", "yay", Res.string.sign_name_sagittarius, Res.string.sign_dates_sagittarius, Res.drawable.sagittarius_constellation_icon, startDay = 22, startMonth = 11),
    CAPRICORN("capricorn", "capricorn", "oglak", Res.string.sign_name_capricorn, Res.string.sign_dates_capricorn, Res.drawable.capricorn_constellation_icon, startDay = 22, startMonth = 12),
    AQUARIUS("aquarius", "aquarius", "kova", Res.string.sign_name_aquarius, Res.string.sign_dates_aquarius, Res.drawable.aquarius_constellation_icon, startDay = 20, startMonth = 1),
